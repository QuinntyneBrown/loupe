...
{
    public static async Task<HttpResponseMessage> SubmitAsync(HttpClient client, IReadOnlyDictionary<string, string>? fields = null, string? key = null, string path = "/api/references/images")
    {
        ...
        using var request = new HttpRequestMessage(HttpMethod.Post, path) { Content = upload };
