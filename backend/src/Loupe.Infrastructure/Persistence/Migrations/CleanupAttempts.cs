...
namespace Loupe.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260907215606_CleanupAttempts")]
    public class CleanupAttempts : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropIndex(
                name: "IX_deletions_CompletedAt_DeletedAt",
                schema: "journal",
                table: "deletions");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_deletions_CompletedAt_LastAttemptAt_DeletedAt",
                schema: "journal",
                table: "deletions",
                columns: new[] { "CompletedAt", "LastAttemptAt", "DeletedAt" });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                ...
                schema: "journal",
                table: "deletions",
                columns: new[] { "CompletedAt", "DeletedAt" });
        }
        /// <inheritdoc />
