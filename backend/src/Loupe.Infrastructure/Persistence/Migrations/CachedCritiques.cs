...
namespace Loupe.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260908000509_CachedCritiques")]
    public class CachedCritiques : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("""
                UPDATE background_operations AS operation
                SET "OutputJson" = photograph."CritiqueJson"
                FROM photographs AS photograph
                WHERE operation."ResourceId" = photograph."Id"
                  AND operation."OwnerId" = photograph."OwnerId"
                  AND operation."Type" = 'Critique' AND operation."Status" = 'Succeeded'
                  AND operation."Id"::text = photograph."CritiqueJson" ->> 'OperationId';
                """);
        }
