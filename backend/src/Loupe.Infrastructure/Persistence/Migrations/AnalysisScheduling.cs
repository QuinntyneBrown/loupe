...
namespace Loupe.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260908005942_AnalysisScheduling")]
    public class AnalysisScheduling : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "analysis_dispatch_cursor",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_analysis_dispatch_cursor", x => x.Id);
                });

            migrationBuilder.InsertData(
                table: "analysis_dispatch_cursor",
