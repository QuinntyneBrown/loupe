...
namespace Loupe.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260912192005_LocationIndex")]
    public sealed class LocationIndex : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AddColumn<Guid>(
                name: "CurrentIndexOperationId",
                table: "locations",
                type: "uuid",
                nullable: true);

            migrationBuilder.CreateIndex(
                name: "IX_locations_CurrentIndexOperationId",
                table: "locations",
                column: "CurrentIndexOperationId");

            migrationBuilder.AddForeignKey(
                name: "FK_locations_background_operations_CurrentIndexOperationId",
                table: "locations",
                column: "CurrentIndexOperationId",
