...
namespace Loupe.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260912143521_Locations")]
    public sealed class Locations : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Setting = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: true),
                    ScoutingBrief = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_locations_Id_OwnerId", x => new { x.Id, x.OwnerId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_location_tags", x => new { x.LocationId, x.NormalizedName });
                    table.ForeignKey(
                        name: "FK_location_tags_locations_LocationId_OwnerId",
                        columns: x => new { x.LocationId, x.OwnerId },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_location_tags_LocationId_OwnerId",
                table: "location_tags",
                columns: new[] { "LocationId", "OwnerId" });

            migrationBuilder.CreateIndex(
                name: "IX_location_tags_OwnerId_NormalizedName",
                table: "location_tags",
                columns: new[] { "OwnerId", "NormalizedName" });

            migrationBuilder.CreateIndex(
                name: "IX_locations_OwnerId_CreatedAt_Id",
                table: "locations",
