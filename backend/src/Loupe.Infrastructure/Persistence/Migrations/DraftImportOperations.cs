...
namespace Loupe.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260911135326_DraftImportOperations")]
    public sealed class DraftImportOperations : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_reference_drafts_ImportOperationId",
                table: "reference_drafts",
                column: "ImportOperationId");

            migrationBuilder.AddForeignKey(
                name: "FK_reference_drafts_background_operations_ImportOperationId",
                table: "reference_drafts",
                column: "ImportOperationId",
