...
namespace Loupe.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260907213950_DeletionJournal")]
    public class DeletionJournal : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MediaKeys = table.Column<string[]>(type: "text[]", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_deletions_OwnerId_ResourceType_ResourceId",
                schema: "journal",
                table: "deletions",
                columns: new[] { "OwnerId", "ResourceType", "ResourceId" },
                unique: true);
        }
            ...
            modelBuilder.Entity("Loupe.Domain.Deletions.DeletionOperation", b =>
                {
                    ...
                    b.HasIndex("CompletedAt", "DeletedAt");
