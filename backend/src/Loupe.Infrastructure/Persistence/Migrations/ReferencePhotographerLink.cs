...
namespace Loupe.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260911171521_ReferencePhotographerLink")]
    public sealed class ReferencePhotographerLink : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_references_PhotographerId_OwnerId",
                table: "references",
                columns: new[] { "PhotographerId", "OwnerId" });

            migrationBuilder.AddForeignKey(
                name: "FK_references_photographers_PhotographerId_OwnerId",
                table: "references",
                columns: new[] { "PhotographerId", "OwnerId" },
