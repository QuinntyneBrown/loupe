...
namespace Loupe.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260908065341_CurrentReferenceImport")]
    public class CurrentReferenceImport : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AddColumn<Guid>(
                name: "CurrentImportOperationId",
                table: "references",
                type: "uuid",
                nullable: true);
            migrationBuilder.Sql("""
                UPDATE "references" reference SET "CurrentImportOperationId" = (
                    SELECT operation."Id" FROM background_operations operation
                    WHERE operation."ResourceId" = reference."Id" AND operation."OwnerId" = reference."OwnerId"
                      AND operation."Type" = 'ReferenceImport'
