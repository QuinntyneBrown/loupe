...
namespace Loupe.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260911133909_ReferenceDrafts")]
    public sealed class ReferenceDrafts : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "reference_drafts",
                columns: table => new
                {
                    ...
                    CommittedReferenceId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_reference_drafts", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_reference_drafts_OwnerId_ExpiresAt",
                table: "reference_drafts",
