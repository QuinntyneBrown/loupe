...
namespace Loupe.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260908020737_CurrentCritiqueOperation")]
    public class CurrentCritiqueOperation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AddColumn<Guid>(
                name: "CurrentCritiqueOperationId",
                table: "photographs",
                type: "uuid",
                nullable: true);
            migrationBuilder.Sql("""
                UPDATE photographs photograph
                SET "CurrentCritiqueOperationId" = (
                    SELECT operation."Id" FROM background_operations operation
                    WHERE operation."OwnerId" = photograph."OwnerId"
                      AND operation."ResourceId" = photograph."Id" AND operation."Type" = 'Critique'
                    ORDER BY operation."CreatedAt" DESC, operation."Id" DESC LIMIT 1
                )
                """);
        }
