...
namespace Loupe.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260912172126_LocationScouting")]
    public sealed class LocationScouting : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AddColumn<Guid>(
                name: "CurrentScoutingOperationId",
                table: "locations",
                type: "uuid",
                nullable: true);

            migrationBuilder.AddColumn<string>(
                name: "ScoutingReportJson",
                table: "locations",
                type: "jsonb",
                nullable: true);

            migrationBuilder.CreateIndex(
                name: "IX_locations_CurrentScoutingOperationId",
                table: "locations",
                column: "CurrentScoutingOperationId");

            migrationBuilder.AddForeignKey(
                name: "FK_locations_background_operations_CurrentScoutingOperationId",
                table: "locations",
                column: "CurrentScoutingOperationId",
