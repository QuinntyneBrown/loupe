...
namespace Loupe.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260911174041_PhotographerDrafts")]
    public sealed class PhotographerDrafts : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "photographer_drafts",
                columns: table => new
                {
                    ...
                    CommittedPhotographerId = table.Column<Guid>(type: "uuid", nullable: true),
                    FailureCode = table.Column<string>(type: "text", nullable: true),
                    ImportOperationId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_photographer_drafts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_photographer_drafts_background_operations_ImportOperationId",
                        column: x => x.ImportOperationId,
                        principalTable: "background_operations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                });

            migrationBuilder.CreateIndex(
                name: "IX_photographer_drafts_ImportOperationId",
                table: "photographer_drafts",
                column: "ImportOperationId");

            migrationBuilder.CreateIndex(
                name: "IX_photographer_drafts_OwnerId_ExpiresAt",
                table: "photographer_drafts",
