...
namespace Loupe.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260911130609_ReferenceTags")]
    public sealed class ReferenceTags : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_reference_tags", x => new { x.ReferenceId, x.NormalizedName });
                    table.ForeignKey(
                        name: "FK_reference_tags_references_ReferenceId_OwnerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_reference_tags_OwnerId_NormalizedName",
                table: "reference_tags",
                columns: new[] { "OwnerId", "NormalizedName" });

            migrationBuilder.CreateIndex(
                name: "IX_reference_tags_ReferenceId_OwnerId",
                table: "reference_tags",
