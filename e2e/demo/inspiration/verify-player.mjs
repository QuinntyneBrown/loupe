...
const output=new URL('../../../docs/demo/inspiration/',import.meta.url);
...
try {
 ...
 await player.chapter(chapters[2]);await page.screenshot({path:new URL('source/player.png',output).pathname.replace(/^\/([A-Z]:)/,'$1')});
