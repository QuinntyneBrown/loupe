...
test("fonts: sign-in loads self-hosted Instrument Sans and Spline Sans Mono", async ({
  page,
}) => {
...
for (const viewport of viewports) {
  test(`L2-044/045/046: sign-in reflows and remains accessible at ${viewport.width}x${viewport.height}`, async ({
    page,
  }, info) => {
