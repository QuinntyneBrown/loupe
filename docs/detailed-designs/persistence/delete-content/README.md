...
| --- | --- | --- |
| `L2-031` | `L1-008` | Users must be able to delete a photograph, reference, photographer bookmark, or location. The UI must name the item and explain its deletion effects before confirmation. Deletion must revoke read access at acknowledgment and schedule complete cleanup. (Updated 2026-09-12: locations.) |
