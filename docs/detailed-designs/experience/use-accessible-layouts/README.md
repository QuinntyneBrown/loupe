...
| --- | --- | --- |
| `L2-044` | `L1-011` | All screens, editors, dialogs, and pickers must work at the shared viewport matrix. My Work and Inspiration image grids use one column below 576 CSS pixels, two from 576-767, three from 768-991, four from 992-1199, and five from 1200 upward. Photographer/search collections use one, two, three, three, and four respectively. Detail image/metadata regions stack below 992 and sit alongside each other from 992 upward; comparison follows L2-005. Compact navigation below 992 must still expose every main area through an accessible menu. |
