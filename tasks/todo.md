...
- [ ] L2-055.1: Given an authenticated user and only a valid name, when Add location is saved, then one location record appears in Locations after reload showing the name, Address not recorded, No images, and No scouting report, and it never appears in My Work, Inspiration, Photographers, or Inspiration Search.
